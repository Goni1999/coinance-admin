    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-end justify-between mt-5">
          <div>
            <span className="text-sm text-gray-500 dark:text-gray-400">{t("spot12")}</span>
...
{t("spot13")} 
          ...
          <button className="inline-flex items-center lg:px-20 gap-2 mt-4 rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-theme-sm font-medium text-gray-500 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 pointer-events-none cursor-not-allowed">
          {t("spot10")}
          </button>
