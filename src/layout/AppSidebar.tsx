...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: t('navbar2'),
    subItems: [
      { name: t('navbar3'), path: "/overview", pro: false },
      { name: t('navbar4'), path: "/spot", pro: false },
      { name: t('navbar5'), path: "/managewallet-deposit", pro: false,},// This opens the link in a new tab      
  ...
  },
  {
    ...
    name: t('navbar6'),
    subItems: [
      { name: t('navbar7'), path: "/spotorder", pro: true },
      { name: t('navbar8'), path: "/withdraw", pro: false },
      { name: t('navbar9'), path: "/calendar", new: true, pro: false },
      { name: t('navbar10'), path: "/transactions", pro: false },
  ...
  },
  {
    ...
    name: t('navbar12'),
    subItems: [
      { name: t('navbar13'), path: "/identification", pro: false },
      { name: t('navbar14'), path: "/security", pro: false },
      { name: t('navbar15'), path: "/payments", pro: false },
      { name: t('navbar16'), path: "/accountstatement", pro: false },
      { name: t('navbar17'), path: "/financialreports", pro: false },
